            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Client</h6>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Business
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Clients Request</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pending Card Amounts</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Wallets</h4>
                                <div id="campaign-v2" class="mt-2" style="height:283px; width:100%;"></div>
                                <ul class="list-style-none mb-0">
                                    <li>
                                        <i class="fas fa-circle text-primary font-10 mr-2"></i>
                                        <span class="text-muted">Pending Amounts </span>
                                    ...
                                    <li class="mt-3">
                                        ...
                                        <span class="text-muted">Total Wallets</span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-inline text-center mt-5 mb-2">
                                    <li class="list-inline-item text-muted font-italic">Profit In this month</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">World Map</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4 activity">
                                    <div class="d-flex align-items-start border-left-line pb-3">
                                        ...
                                        <div class="ml-3 mt-2">
                                            <h5 class="text-dark font-weight-medium mb-2">New Card Generated!</h5>
                                            <p class="font-14 mb-2 text-muted">Shiskha just created the Request 
                                            </p>
                                    ...
                                    <div class="d-flex align-items-start border-left-line pb-3">
                                        ...
                                        <div class="ml-3 mt-2">
                                            ...
                                            <p class="font-14 mb-2 text-muted">Client, Haryana just create support <br>
                                                ticket</p>
                                    ...
                                    <div class="d-flex align-items-start border-left-line">
                                        ...
                                        <div class="ml-3 mt-2">
                                            <h5 class="text-dark font-weight-medium mb-2">Notification Pending Card Data
                                            </h5>
                                            <p class="font-14 mb-2 text-muted">One Pending Request from Client <br> Doe</p>

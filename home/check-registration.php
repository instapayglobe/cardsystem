      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        	<div class="col-12">
          	...
          	<form  class="contact_bg" action="result-student.php" method="POST">
                         
				<input type="text" name="stu_name" placeholder="Enter Your Registration Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Registration Number Required'"
